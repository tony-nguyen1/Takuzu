...
public class Takuzu {
    ...
    public boolean seResoudre(Solveur lesSolveursSimples) { return lesSolveursSimples.resoudre(this); }

    // public static Takuzu seResoudre(Hypotheses hypotheses) { return hypotheses.generer(); }
